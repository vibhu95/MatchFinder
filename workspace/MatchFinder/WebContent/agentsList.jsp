...
%>
								...
								<div class="friends-grids">
									<div class="grids-left">
										<img class="img-circle" width="120px" height="120px" src="getImage.jsp?id=<%=b.getId() %>" />
									</div>	
									...
									<ul class="grids-right-info">
											<li class="user"><%=b.getAge_of_agent() %></li>
											<li class="camera"><%=b.getAge_of_Business() %></li>
											<li class="chat"><%=b.getId() %></li>
										<div class="clear"> </div>
									</ul>
									</div>
									<div class="clear"> </div>
