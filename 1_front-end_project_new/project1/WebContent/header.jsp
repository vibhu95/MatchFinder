<!-- header -->
							...
							<div class="sap_tabs">	
								<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
									...
									<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="facts">
											<div class="register">
												<form action="Register" method="post" id="Myform" name="MyForm">			
	...
	%>
			<div class="header">
			<div style="font-size:20px; color:silver; text-align:center" width="5px"><b>Welcome  ${username}</b></div>
				<div class="container">
				<div class="w3l_login">
	<%
	if(session.getAttribute("username")==null)
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<!-- Mega Menu -->
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" onmouseover="dropdown()" onclick="dropdown()" data-toggle="dropdown">Products <b class="caret"></b></a>
							<ul class="dropdown-menu multi-column columns-3" id="dropdown-menu multi-column columns-3" onmouseout="dropup()" style="display:none;">
								<div class="row">
								
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>Clothing</h6>
											<li><a href="dresses.jsp">Dresses<span>New</span></a></li>
											<li><a href="sweaters.jsp">T-shirts</a></li>
											<li><a href="shirts.jsp">Shirts <span>New</span></a></li>
								...
								<div class="col-sm-3">
										<ul class="multi-column-dropdown">
								<!-- 			<h6>Ethnic Wear</h6>
											<li><a href="salwars.jsp">Salwars</a></li>
											<li><a href="sarees.jsp">Sarees<span>New</span></a></li>
									-->		<li><a href="products.jsp"><i>Summer Store</i></a></li>
										</ul> 
									</div>
							<!-- 		<div class="col-sm-2">
										<ul class="multi-column-dropdown">
											...
											<li><a href="sandals.jsp">Heels</a></li>
										</ul>
									</div>
							-->		
									<div class="col-sm-4">
